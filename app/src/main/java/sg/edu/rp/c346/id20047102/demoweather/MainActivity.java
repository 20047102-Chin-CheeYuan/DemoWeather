package sg.edu.rp.c346.id20047102.demoweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        ArrayAdapter<Weather> weatherAdapter = new ArrayAdapter<Weather>(this, android.R.layout.simple_list_item_1, alWeather);
